        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xl font-bold text-slate-900 tracking-tight">Registrasi Pengguna Baru</h1>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="max-w-3xl mx-auto w-full space-y-6">
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8">
                        <h2 class="text-lg font-bold text-slate-900 mb-1">Formulir Registrasi Akun</h2>
                        <p class="text-slate-500 text-xs mb-6">Daftarkan akun pengguna baru dengan menetapkan peran (role) yang tepat.</p>
                        ...
                        <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
                            ...
                            <!-- Password field -->
                            <div>
                                <label for="password" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Kata Sandi Sementara</label>
