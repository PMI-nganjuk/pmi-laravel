<x-app-layout>
    <x-layout.shell page-title="Registrasi Pengguna Baru">
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-3xl mx-auto w-full space-y-6">
                ...
                <x-atoms.surface class="p-6 sm:p-8">
                    <h2 class="text-lg font-bold text-content-base mb-1">Formulir Registrasi Akun</h2>
                    <p class="text-content-muted text-xs mb-6">Daftarkan akun pengguna baru dengan menetapkan peran (role) yang tepat.</p>
